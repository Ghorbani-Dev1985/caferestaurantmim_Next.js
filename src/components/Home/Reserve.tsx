...
const Reserve = () => {
  return (
    <section className="container">
      <div className="flex-col md:flex-row flex-between h-40 md:h-32 bg-gradient-to-l from-primary-400 to-primary-700 text-white rounded-3xl my-9 px-4 py-5 md:py-2">
